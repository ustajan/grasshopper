...
class astar_api_visualize(object):
    """
    ...
    """
    def __init__(self):
        self.desc = "astar api visualization tools"
    ...
    def plot_data(self, list_v, options=[], x_s=None, y_s=None, z_s=None):
        ...
        """
        # XCOM data loader
        x_d_loader = [list_v[::7], list_v[1::7], list_v[2::7], list_v[3::7],
                      list_v[4::7], list_v[5::7], list_v[6::7]]
        plt.figure(1)
        ...
        plt.ylabel("(cm2/g)")
        plt.savefig("../Results/Figures/astar_api_figure_{}.png".format(time.time()))
        return 0
